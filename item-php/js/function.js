...
$('.header__head--lang-btn').on( 'click', function() {
    $(this).toggleClass('active')
    if($(this).hasClass('active')){
        $('.header__head--lang-list').addClass('active');
    }else {
        $('.header__head--lang-list').removeClass('active');
    }
})

$('.header__head--lang-item').on( 'click', function() {
    $('.header__head--lang-list').removeClass('active');
})

$('.header__head--close').on( 'click', function() {
    $('.header__head').remove();
})