            ...
            <div class="header__head--lang">
                <div class="header__head--lang-btn d-none d-lg-flex align-items-center">
                    <div class="header__head--lang-active d-flex align-items-center regular">
                        <img src="./img/svg/georgia.svg" alt="">
                        Geo
                    </div>
                    <img src="./img/svg/lang-arrow-down.svg" alt="">
                </div>
                <div class="header__head--lang-list">
                    ...
                    <div class="header__head--lang-item d-flex align-items-center regular">
                        <img src="./img/svg/england.svg" alt="">
                        En
                    </div>
                </div>
                <button class="header__head--close btn d-block d-lg-none">
                    <img src="./img/svg/close-head-green.svg" alt="">
                </button>
            </div>
        </div>
    </div>
                ...
                <ul class="m-header__menu d-flex justify-content-between">
                        ...
                        <a href="/?act=home" class="m-header__menu--a regular d-flex flex-column align-items-center">
                            <figure class="m-header__menu--figure d-flex justify-content-center">
                                <div class="m-header__menu--icon">
                                    <img src="img/svg/menu/home1.svg" class="convert-svg" alt="">
                                </div>
                            </figure>
                            <p>
                                Home
                    ...
                    <li class="m-header__menu--li">
                        <a href="/?act=market" class="m-header__menu--a active regular d-flex flex-column align-items-center">
                            <figure class="m-header__menu--figure d-flex justify-content-center">
                                <div class="m-header__menu--icon">
                                    <img src="img/svg/menu/market1.svg" class="convert-svg" alt="">
                                </div>
                            </figure>
                            <p>
                                Market
                    ...
                    <li class="m-header__menu--li">
                        <a href="/?act=shop" class="m-header__menu--a regular d-flex flex-column align-items-center">
                            <figure class="m-header__menu--figure d-flex justify-content-center">
                                <div class="m-header__menu--icon">
                                    <img src="img/svg/menu/shop1.svg" class="convert-svg" alt="">
                                </div>
                            </figure>
                            <p>
                                Shop
                    ...
                    <li class="m-header__menu--li">
                        <a href="/?act=social_program" class="m-header__menu--a regular d-flex flex-column align-items-center">
                            <figure class="m-header__menu--figure d-flex justify-content-center">
                                <div class="m-header__menu--icon">
                                    <img src="img/svg/menu/social1.svg" class="convert-svg" alt="">
                                </div>
                            </figure>
                            <p>
                                Social Programs
                    ...
                    <li class="m-header__menu--li">
                        <a href="/?act=charities" class="m-header__menu--a regular d-flex flex-column align-items-center">
                            <figure class="m-header__menu--figure d-flex justify-content-center">
                                <div class="m-header__menu--icon">
                                    <img src="img/svg/menu/charitys1.svg" class="convert-svg" alt="">
                                </div>
                            </figure>
                            <p>
                                Charities 
                    ...
                    <li class="m-header__menu--li">
                        <a href="/charities-touch.html" class="m-header__menu--a regular d-flex flex-column align-items-center">
                            <figure class="m-header__menu--figure d-flex justify-content-center">
                                <div class="m-header__menu--icon">
                                    <img src="img/svg/menu/news1.svg" class="convert-svg" alt="">
                                </div>
                            </figure>
                            <p>
                                News 
        ...
        <div class="mobile-categories">
            <div class="mobile-categories__head">
                <button class="mobile-categories__head--close">
                    <img src="img/svg/clear-bold.svg" alt="">
                </button>
                <div class="d-flex justify-content-center">
                    <img src="img/svg/popup-logo.svg" alt="">
                </div>
            ...
            <div class="row">
                <div class="col-2 d-none d-lg-block">
                    <div class="header__logo d-flex align-items-center">
                        <img src="img/svg/header-logo.svg" alt="" class="header__logo--img">
                    </div>
                </div>
                <div class="col-10 d-none d-lg-flex justify-content-between align-items-center">
                    ...
                    <ul class="header__btns d-flex align-items-center justify-content-end">
                        ...
                        <div class="header__account click-open d-flex align-items-center justify-content-between" data-active="login-popup">
                            <div class="d-flex">
                                <div class="header__account--avatar d-flex align-items-center justify-content-center">
                                    <img src="img/svg/header-btn/avatar.svg" alt="">
                                </div>
                            ...
                            <div class="d-flex justify-content-center" style="position: relative;">
                                <img src="img/svg/header-btn/arrow.svg" alt="" class="header__account--icon">
                            </div>
                        </div> 
                        
                        <!-- is loged in / profile window -->
                        <!-- <div class="header__account click-open d-flex align-items-center justify-content-between" data-active="profile-window">
                                <div class="d-flex">
                                    <div class="header__account--avatar d-flex align-items-center justify-content-center">
                                        <img src="img/svg/header-btn/avatar.svg" alt="">
                                    </div>
                                ...
                                <div class="d-flex justify-content-center" style="position: relative;">
                                    <img src="img/svg/header-btn/arrow.svg" alt="" class="header__account--icon">
                                    <div class="profile open-active" data-active="profile-window">
                        ...
                        <li class="header__btns--item click-open" data-active="cart-popup">
                            ...
                            <a href="" class="header__btns--link d-flex align-items-center justify-content-center">
                                <img src="img/svg/header-btn/shop.svg" alt="">
                            </a>
                        </li>
                    </ul>
                </div>
                                            ...
                                            if($page_name == 'market') {
                                                echo '
                                                    <button class="open-filter d-flex align-items-center justify-content-center regular">
                                                        <img src="./img/svg/filter-icon.svg" alt="">
                                                        Filter
                                                    </button>
                                                ' ;
                                            }
                ...
                <div class="row">
                    <div class="col-12 d-lg-none">
                        <form class="m-header__search d-flex align-items-center justify-content-end">
                            ...
                            <div class="m-search-cancel"><img src="img/svg/header-btn/m-search-cancel.svg" alt=""></div>
                        </form>
                    </div>
                    <div class="col-12">
                        <div class="row">
    ...
    <div class="head-menu--fix d-none d-lg-block">
        <div class="container">
            <div class="head-menu d-flex justify-content-between align-items-center">
                <ul class="head-menu__categories d-flex">
                    <li class="head-menu__categories--item">
                        <a href="<?php echo $base_url;?>?act=home" class="head-menu__categories--link regular  d-flex align-items-center">
                            <img src="img/svg/menu/home.svg" alt="" class="head-menu__categories--icon convert-svg">
                            Home
                        </a>
                    </li>
                    <li class="head-menu__categories--item">
                        <a href="<?php echo $base_url;?>?act=market" class="head-menu__categories--link active regular  d-flex align-items-center">
                            <img src="img/svg/menu/market.svg" alt="" class="head-menu__categories--icon convert-svg">
                        Market
                    </a>
                    </li>
                    <li class="head-menu__categories--item">
                        <a href="<?php echo $base_url;?>?act=shop" class="head-menu__categories--link regular  d-flex align-items-center">
                            <img src="img/svg/menu/shop.svg" alt="" class="head-menu__categories--icon convert-svg">
                            Shop
                        </a>
                    </li>
                    <li class="head-menu__categories--item">
                        <a href="<?php echo $base_url;?>?act=charities" class="head-menu__categories--link regular  d-flex align-items-center">
                            <img src="img/svg/menu/charitys.svg" alt="" class="head-menu__categories--icon convert-svg">
                            Charitys And Other NPOs
                        </a>
                    </li>
                    <li class="head-menu__categories--item">
                        <a href="<?php echo $base_url;?>?act=social-program" class="head-menu__categories--link regular  d-flex align-items-center">
                            <img src="img/svg/menu/social.svg" alt="" class="head-menu__categories--icon convert-svg">
                            Social Programs
                        </a>
                    </li>
                    <li class="head-menu__categories--item">
                        <a href="<?php echo $base_url;?>?act=news" class="head-menu__categories--link regular  d-flex align-items-center">
                            <img src="img/svg/menu/news.svg" alt="" class="head-menu__categories--icon convert-svg convert-svg">
                            News
                        </a>
                    </li>
                </ul>
                <ul class="head-menu__categories d-flex">
                    <li class="head-menu__categories--item">
                        <a href="" class="head-menu__categories--link regular">About us</a>
                    </li>
                    <li class="head-menu__categories--item">
                        <a href="" class="head-menu__categories--link regular">Help&Contact</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <ul class="fix-bar__lists d-flex justify-content-between align-items-start">
                <li class="fix-bar__lists--li">
                    <a href="" data-active="cart-popup" class="fix-bar__lists--link regular d-flex align-items-center flex-column click-open">
                        <figure class="fix-bar__lists--icon">
                            <img src="img/svg/header-btn/bar-cart.svg" alt="">
                        </figure>
                        Cart
                    </a>
                </li>
                ...
                <li class="fix-bar__lists--btn">
                    <a href="" class="d-flex align-items-center flex-column">
                        <img src="img/svg/header-btn/bar-add.svg" alt="">
                    </a>
                </li>
                <li class="fix-bar__lists--li">
                    <a href="" class="fix-bar__lists--link regular d-flex align-items-center flex-column">
                        <figure class="fix-bar__lists--icon">
                            <img src="img/svg/messages.svg" alt="">
                        </figure>
                        Messages
                    </a>
                </li>
